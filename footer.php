...
?>
	<footer class="container-fluid">
		<div class="row bgGray">
			...
			<div class="col-sm-12 col-md-4 footer-col">
				<div class="container-fluid">
					<div class="row">
						<div class="col-12">
							<figure class="logos"><a href="http://www.lasalle.mx/" target="_blank"><img src="images/footer/Footer_Logo_Imagotipo.png" alt="Universidad La Salle" class="img-responsive" align="left"></a></figure>
						</div>
					</div>
					<div class="row">
						<div class="col-12">
					...
					<div class="row">
						<div class="col-12">
							<figure class="logos"><a href="http://www.lasalle.mx/" target="_blank"><img src="images/footer/Footer_Logo_Universidad-Segura.png" alt="Universidad Segura" class="img-responsive" align="left"></a></figure>
						</div>
					</div>
				</div>
			</div>
		...
		<div class="row bgBlack" >
			<p>© Universidad La Salle A.C. 2017 Todos los derechos Reservados.</p>
		</div>
		<div class="row bgWhite">
				...
				<div class="col-sm-12 col-12 resumenAviso">
					<p>
				...
				<div class="col-sm-12 col-12 resumenTerminos">
