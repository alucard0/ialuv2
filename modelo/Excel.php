...
include_once 'Classes/PHPExcel/Writer/Excel2007.php';
	...
	class Excel
	{
		...
		public function __construct($post)
		{
			...
			$this->objPHPExcel->getDefaultStyle()->getNumberFormat()->setFormatCode(PHPExcel_Style_NumberFormat::FORMAT_TEXT);
		...
		public function renombrar_hoja ($nombre){
			$objWorkSheet = $this->objPHPExcel->getActiveSheet();
			$objWorkSheet->setTitle($nombre);
		}
		
		public function crear_hoja ($index, $nombre) {
			$objWorkSheet = $this->objPHPExcel->createSheet($index);
			$objWorkSheet->setTitle($nombre);
		}
